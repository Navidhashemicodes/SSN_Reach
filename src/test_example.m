function [classes, Detection_table] = test_example()
Ns = 1000;%100000;
Nsp = 1000;%100000;
start_loc = [1 , 1];
rank = 999;%99999;
...
dir0 = pwd;
dir = fileparts(dir0);
dir1 = [ dir  '/benchmarks/M2NIST_project/models'];
dir2 = [ dir  '/benchmarks/M2NIST_project/images'];
cd(dir1)
load(model_name)
layers = net.Layers;

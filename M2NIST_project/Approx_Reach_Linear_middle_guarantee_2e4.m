...
tic
%%%%%%%%%%%%%%%
res_trn = abs( Y - ( directions * ( A*X + b ) + C ) );
...
tic
%%%%%%%%%%%%%%
res_tst = abs(Y_test - ( directions*( A*X_test + b ) + C ));
...
save("CI_result_middle_guarantee_Linear_2e4_004.mat", "robust", "nonrobust", "attacked", "unknown", "True_class", "classes", "Conf"        , ...
